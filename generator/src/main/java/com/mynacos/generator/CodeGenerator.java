...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/order?characterEncoding=utf8&useSSL=false&allowMultiQueries=true");
